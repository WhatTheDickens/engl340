...
- **Blog**: You'll earn up to **30** points for two blog posts (15 points each) in which you reflect on your learning in this course. (For due dates, see the individual assignment pages under [Blog Assignments]({{ site.url }}/mod-92/overview)). 
- **Class work**: You'll earn up to **40** points for in-class work submitted *by the end of each class meeting.* (Typically, 1 point per timely, substantive submission.) If you're unable to attend class, you can submit the in-class work for credit *up to 3 times* over the course of the semester and still earn credit for it, provided you submit it the day of the class meeting.
...
- Hold off on carrying out the instructions in [Keep a Daily Journal in Markdown]({{ site.url }}/mod-3/keep-a-daily-journal) until we meet in class.
...
- Read Rebecca Solnit, "[Mysteries of Thoreau, Unsolved](https://docs.google.com/document/d/1KZhF8YLTvjNBjyxiPAgK4Shgg-TRUow7jr2baAMZlfA/edit?usp=sharing)".
...
- Read Maria Popova, "[How Not to Waste Your Life](https://www.themarginalian.org/2025/10/31/hawthorne-life/)".
- Choose a sentence or passage anywhere in paragraphs 1-70 of "Economy" in *Walden* that you can connect with one of the other readings for today. Write a comment explaining the connection.
...
- Read [AI Hype]({{ site.url }}/mod-4a/ai-hype), [AI Harms]({{ site.url }}/mod-4a/ai-harms), and [Towards Responsible AI]({{ site.url }}/mod-4a/responsible-ai).
